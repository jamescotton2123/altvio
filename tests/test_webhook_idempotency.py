...
def test_docusign_webhook_duplicate_payload_is_already_processed():
    ...
    with patch.dict(sys.modules, {"core.database": fake_database}):
        ...
        first_response = client.post("/docusign/webhook", content=payload, headers=headers)
        second_response = client.post("/docusign/webhook", content=payload, headers=headers)
